...
FOOD_STRAIN_PATTERNS = (
    ...
    ("geographic access gap", r"\b(?:only|sole|full-service|last)\b.{0,50}\b(?:grocery store|supermarket|food mart|market)\b.{0,140}\b(?:fire|burn(?:ed|t|s|ing)?|destroy(?:ed|s)?|damag(?:ed|e)|clos(?:ed|ing|ure)|without)\b"),
    ("geographic access gap", r"\b(?:fire|burn(?:ed|t|s|ing)?|destroy(?:ed|s)?|damag(?:ed|e)|clos(?:ed|ing|ure))\b.{0,140}\b(?:only|sole|full-service|last)\b.{0,50}\b(?:grocery store|supermarket|food mart|market)\b"),
    ...
    ("benefit access failure", r"\b(?:SNAP|food stamps?)\b.{0,160}\b(?:loss|losses|lost|cut(?:s)?|reduction|reduced|declin(?:e|ed|es|ing)|participation decline|fewer households)\b.{0,160}\b(?:food bank|food pantry|emergency food|demand|need|strain|increase)\b"),
    ("benefit access failure", r"\b(?:food bank|food pantry|emergency food|demand|need|strain|increase)\b.{0,160}\b(?:SNAP|food stamps?)\b.{0,160}\b(?:loss|losses|lost|cut(?:s)?|reduction|reduced|declin(?:e|ed|es|ing)|participation decline|fewer households)\b"),
...
CARE_STRAIN_PATTERNS = (
    ...
    ("facility or service closure", r"\b(?:birth center|birthing center|deliveries|delivery options?)\b.{0,160}\b(?:pause(?:d|s|ing)?|end(?:ed|ing|s)?|stop(?:ped|ping|s)?|suspend(?:ed|s|ing)?|transition(?:ed|ing)?)\b"),
    ...
    ("service reduction", r"\b(?:IT|cyber|technology|systems?|outage|incident)\b.{0,160}\b(?:clinic|walk-in|appointments?|patient communications?|communications?)\b.{0,160}\b(?:cancel(?:ed|led|s|lation)?|unavailable|delayed?|postponed|closed)\b"),
    ("service reduction", r"\b(?:clinic|walk-in|appointments?|patient communications?|communications?)\b.{0,160}\b(?:cancel(?:ed|led|s|lation)?|unavailable|delayed?|postponed|closed)\b.{0,160}\b(?:IT|cyber|technology|systems?|outage|incident)\b"),
