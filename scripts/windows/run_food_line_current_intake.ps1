...
$arguments = @($helper, "intake", "--repo-root", $RepositoryRoot, "--python", $PythonExecutable, "--edition-date", $EditionDate, "--branch", $SourceBranch, "--lock-wait-seconds", $LockWaitSeconds)
