...
An operator may accept an independent substantive review for an existing ICE or Care Line historical candidate with the status-only private review command:
