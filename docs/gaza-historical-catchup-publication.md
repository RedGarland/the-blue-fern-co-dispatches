...
The former v1 approval contract was date-keyed. It is intentionally obsolete and cannot authorize the catch-up namespace. A renewed independent human approval using the v2 path-bound contract is required.
