...
def _write_food_line_operational_health_receipt(
    ...
    *,
    ...
    receipt = build_food_line_operational_receipt(
        ...
        run_id=_nonempty_text(task_receipt.get("run_id") or task_receipt.get("qualifying_discovery_run_id")),
        ...
        details={
            ...
            "edition_date": task_receipt.get("edition_date"),
            "qualifying_discovery_run_id": task_receipt.get("qualifying_discovery_run_id"),
            "source_status": task_receipt.get("source_status") or task_receipt.get("final_status"),
            "source_export_status": task_receipt.get("source_export_status") or task_receipt.get("export_status"),
            "inbox_export_path": task_receipt.get("inbox_export_path"),
            "inbox_export_sha256": task_receipt.get("inbox_export_sha256"),
